...
var $author$project$TestTreeStructure$debugTreeHelper = F2(
	function (depth, tree) {
		var indent = A2($elm$core$String$repeat, depth * 2, ' ');
		var childrenDebug = function () {
			...
			if (!_v0.b) {
				...
				return '\n' + A2(
					...
					A2(
						$elm$core$List$map,
						$author$project$TestTreeStructure$debugTreeHelper(depth + 1),
						children));
			}
		}();
		var blockName = A2(
		...
		var blockIndent = $elm$core$String$fromInt(
			$maca$elm_rose_tree$RoseTree$Tree$value(tree).indent);
		return indent + (blockName + (' (indent=' + (blockIndent + (')' + childrenDebug))));
	});
var $author$project$TestTreeStructure$debugTree = function (tree) {
	return A2($author$project$TestTreeStructure$debugTreeHelper, 0, tree);
};
...
var $author$project$TestTreeStructure$sourceText = 'AAA\n\n- Outer 1\n\n  - Inner 1\n\n  - Inner 2\n\n- Outer 2\n\nBBB';
var $elm$virtual_dom$VirtualDom$style = _VirtualDom_style;
var $elm$html$Html$Attributes$style = $elm$virtual_dom$VirtualDom$style;
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$TestTreeStructure$main = function () {
	var ast = A2($author$project$ScriptaV2$Compiler$parseFromString, $author$project$ScriptaV2$Language$SMarkdownLang, $author$project$TestTreeStructure$sourceText);
	var treeDebug = A2(
		$elm$core$String$join,
		'\n\n',
		A2(
			...
			function (_v0) {
				var i = _v0.a;
				var str = _v0.b;
				return 'Tree ' + ($elm$core$String$fromInt(i) + (':\n' + str));
			},
			A2(
				...
				F2(
					function (i, tree) {
						return _Utils_Tuple2(
							i,
							$author$project$TestTreeStructure$debugTree(tree));
					}),
				ast)));
	return A2(
		$elm$html$Html$div,
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Tree Structure Debug')
					])),
				A2(
				$elm$html$Html$h2,
				_List_Nil,
				...
				_List_fromArray(
					[
						$elm$html$Html$text($author$project$TestTreeStructure$sourceText)
					])),
				A2(
				$elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('AST Tree Structure:')
					])),
				A2(
				$elm$html$Html$pre,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(treeDebug)
					]))
			]));
}();
_Platform_export({'TestTreeStructure':{'init':_VirtualDom_init($author$project$TestTreeStructure$main)(0)(0)}});}(this));