			...
			case 'href':
				if (args.b) {
					if (args.b.b) {
						...
						var _v2 = args.b;
						var second = _v2.a;
						var secondStr = $author$project$Render$Export$LaTeXToScripta2$renderExpression(second);
						var firstStr = $author$project$Render$Export$LaTeXToScripta2$renderExpression(first);
						return '[link ' + (secondStr + (' ' + (firstStr + ']')));
					} else {
						var single = args.a;
