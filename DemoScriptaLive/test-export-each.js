...
var $author$project$Render$Settings$default = F4(
	function (displaySettings, theme, selectedId, width) {
		return A7($author$project$Render$Settings$makeSettings, displaySettings, theme, selectedId, $elm$core$Maybe$Nothing, 1, width, $elm$core$Dict$empty);
	});
...
var $author$project$TestExportEach$sourceText = 'AAA\n\n- Outer 1\n\n  - Inner 1\n\n  - Inner 2\n\n- Outer 2\n\nBBB';
var $elm$virtual_dom$VirtualDom$style = _VirtualDom_style;
var $elm$html$Html$Attributes$style = $elm$virtual_dom$VirtualDom$style;
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$TestExportEach$main = function () {
	var theme = $author$project$Render$Theme$Light;
	var displaySettings = $author$project$Render$Settings$defaultDisplaySettings;
	var settings = A4($author$project$Render$Settings$default, displaySettings, theme, '', 500);
	var ast = A2($author$project$ScriptaV2$Compiler$parseFromString, $author$project$ScriptaV2$Language$SMarkdownLang, $author$project$TestExportEach$sourceText);
	var fullExport = A2($author$project$Render$Export$LaTeX$rawExport, settings, ast);
	var individualExports = A2(
		$elm$core$String$join,
		'\n\n========\n\n',
		A2(
			$elm$core$List$indexedMap,
			F2(
				function (i, tree) {
					var exported = A2(
						$author$project$Render$Export$LaTeX$rawExport,
						settings,
						_List_fromArray(
							[tree]));
					var blockName = A2(
						...
						$author$project$Generic$BlockUtilities$getExpressionBlockName(
							$maca$elm_rose_tree$RoseTree$Tree$value(tree)));
					return 'Tree ' + ($elm$core$String$fromInt(i) + (' (' + (blockName + ('):\n' + exported))));
				}),
			ast));
	return A2(
		$elm$html$Html$div,
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Individual Tree Exports')
					])),
				A2(
				$elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Source (Scripta):')
					])),
				A2(
				$elm$html$Html$pre,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text($author$project$TestExportEach$sourceText)
					])),
				A2(
				$elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Each tree exported individually:')
					])),
				A2(
				$elm$html$Html$pre,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(individualExports)
					])),
				A2(
				$elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Full export (all trees together):')
					])),
				A2(
				$elm$html$Html$pre,
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'background', '#ffe0e0'),
						A2($elm$html$Html$Attributes$style, 'padding', '10px'),
						A2($elm$html$Html$Attributes$style, 'white-space', 'pre-wrap')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(fullExport)
					]))
			]));
}();
_Platform_export({'TestExportEach':{'init':_VirtualDom_init($author$project$TestExportEach$main)(0)(0)}});}(this));