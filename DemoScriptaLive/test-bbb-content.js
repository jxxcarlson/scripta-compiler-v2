...
var $author$project$TestBbbContent$sourceText = 'AAA\n\n- Outer 1\n\n  - Inner 1\n\n  - Inner 2\n\n- Outer 2\n\nBBB';
...
var $author$project$TestBbbContent$main = function () {
	var ast = A2($author$project$ScriptaV2$Compiler$parseFromString, $author$project$ScriptaV2$Language$SMarkdownLang, $author$project$TestBbbContent$sourceText);
	var tree3 = $elm$core$List$head(
		A2($elm$core$List$drop, 3, ast));
	var tree3Info = function () {
		if (tree3.$ === 'Nothing') {
			return 'Tree 3 doesn\'t exist!';
		} else {
			var tree = tree3.a;
			var block = $maca$elm_rose_tree$RoseTree$Tree$value(tree);
			var bodyInfo = function () {
				...
				if (_v1.$ === 'Left') {
					...
					var exprs = _v1.a;
					return 'Right: ' + ($elm$core$String$fromInt(
						$elm$core$List$length(exprs)) + ' expressions');
				}
			}();
			return 'Tree 3 exists!\n' + ('Heading: ' + ($elm$core$Debug$toString(block.heading) + ('\n' + ('Body: ' + (bodyInfo + ('\n' + ('Source text: ' + block.meta.sourceText)))))));
		}
	}();
	return A2(
		$elm$html$Html$div,
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('BBB Content Debug')
					])),
				A2(
				$elm$html$Html$h2,
				_List_Nil,
				...
				_List_fromArray(
					[
						$elm$html$Html$text($author$project$TestBbbContent$sourceText)
					])),
				A2(
				$elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Tree 3 (BBB) Info:')
					])),
				A2(
				$elm$html$Html$pre,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(tree3Info)
					]))
			]));
}();
_Platform_export({'TestBbbContent':{'init':_VirtualDom_init($author$project$TestBbbContent$main)(0)(0)}});}(this));