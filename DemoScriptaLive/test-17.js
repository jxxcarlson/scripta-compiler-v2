...
var $author$project$Test17$main = function () {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Test 17: Equation with subscript text')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
...
_Platform_export({'Test17':{'init':_VirtualDom_init($author$project$Test17$main)(0)(0)}});}(this));