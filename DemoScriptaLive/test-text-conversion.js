...
var $author$project$TestTextConversion$test1 = '$10 \\text{ degrees F}$';
var $author$project$TestTextConversion$test2 = '\\begin{align}\n\\ket{0} & \\text{ undecayed}\\\\\n\\ket{1} & \\text{ decayed}\n\\end{align}';
var $author$project$TestTextConversion$test3 = 'The temperature is $T = 10 \\text{ K}$ and pressure is $P = 1 \\text{ atm}$.';
...
var $author$project$TestTextConversion$testCase = F2(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Scripta Output:')
								])),
							A2(
							$elm$html$Html$pre,
							_List_Nil,
...
var $author$project$TestTextConversion$main = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('LaTeX \\text{} Conversion Test')
				])),
			A2($author$project$TestTextConversion$testCase, 'Test 1: Simple text in math', $author$project$TestTextConversion$test1),
			A2($author$project$TestTextConversion$testCase, 'Test 2: Text in align block', $author$project$TestTextConversion$test2),
			A2($author$project$TestTextConversion$testCase, 'Test 3: Complex math with text', $author$project$TestTextConversion$test3)
		]));
_Platform_export({'TestTextConversion':{'init':_VirtualDom_init($author$project$TestTextConversion$main)(0)(0)}});}(this));