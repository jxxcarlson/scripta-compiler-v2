...
var $author$project$Test16$main = function () {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Test 16: Equation with fraction')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
...
_Platform_export({'Test16':{'init':_VirtualDom_init($author$project$Test16$main)(0)(0)}});}(this));