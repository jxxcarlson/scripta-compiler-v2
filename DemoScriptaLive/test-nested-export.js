...
var $author$project$TestNestedExport$expectedOutput = 'AAA\n\n\\begin{itemize}\n  \\item Outer 1\n    \\begin{itemize}\n      \\item Inner 1\n      \\item Inner 2\n    \\end{itemize}\n  \\item Outer 2\n\\end{itemize}\n\nBBB';
...
var $author$project$TestNestedExport$sourceText = 'AAA\n\n- Outer 1\n\n  - Inner 1\n\n  - Inner 2\n\n- Outer 2\n\nBBB\n';
var $elm$virtual_dom$VirtualDom$style = _VirtualDom_style;
var $elm$html$Html$Attributes$style = $elm$virtual_dom$VirtualDom$style;
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$TestNestedExport$main = function () {
	...
	var ast = A2($author$project$ScriptaV2$Compiler$parseFromString, $author$project$ScriptaV2$Language$SMarkdownLang, $author$project$TestNestedExport$sourceText);
	var actualOutput = A2($author$project$Render$Export$LaTeX$rawExport, settings, ast);
	var matches = _Utils_eq(
		$elm$core$String$trim(actualOutput),
		$elm$core$String$trim($author$project$TestNestedExport$expectedOutput));
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Nested List LaTeX Export Test')
					])),
				A2(
				$elm$html$Html$h2,
				_List_Nil,
				...
				_List_fromArray(
					[
						$elm$html$Html$text($author$project$TestNestedExport$sourceText)
					])),
				A2(
				$elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Expected LaTeX Output:')
					])),
				A2(
				$elm$html$Html$pre,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text($author$project$TestNestedExport$expectedOutput)
					])),
				A2(
				$elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Actual LaTeX Output:')
					])),
				A2(
				$elm$html$Html$pre,
				_List_fromArray(
...
_Platform_export({'TestNestedExport':{'init':_VirtualDom_init($author$project$TestNestedExport$main)(0)(0)}});}(this));