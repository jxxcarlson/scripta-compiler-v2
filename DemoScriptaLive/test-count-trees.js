...
var $author$project$TestCountTrees$sourceText = 'AAA\n\n- Outer 1\n\n  - Inner 1\n\n  - Inner 2\n\n- Outer 2\n\nBBB';
var $elm$virtual_dom$VirtualDom$style = _VirtualDom_style;
var $elm$html$Html$Attributes$style = $elm$virtual_dom$VirtualDom$style;
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$TestCountTrees$main = function () {
	...
	var ast = A2($author$project$ScriptaV2$Compiler$parseFromString, $author$project$ScriptaV2$Language$SMarkdownLang, $author$project$TestCountTrees$sourceText);
	var treeCount = $elm$core$List$length(ast);
	var actualOutput = A2($author$project$Render$Export$LaTeX$rawExport, settings, ast);
	var lines = $elm$core$String$lines(actualOutput);
	var lineCount = $elm$core$List$length(lines);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Tree Count Debug')
					])),
				A2(
				$elm$html$Html$h2,
				_List_Nil,
				...
				_List_fromArray(
					[
						$elm$html$Html$text($author$project$TestCountTrees$sourceText)
					])),
				A2(
				$elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Number of trees in AST: ' + $elm$core$String$fromInt(treeCount))
					])),
				A2(
				$elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Number of lines in output: ' + $elm$core$String$fromInt(lineCount))
					])),
				A2(
				$elm$html$Html$h2,
				_List_Nil,
...
_Platform_export({'TestCountTrees':{'init':_VirtualDom_init($author$project$TestCountTrees$main)(0)(0)}});}(this));