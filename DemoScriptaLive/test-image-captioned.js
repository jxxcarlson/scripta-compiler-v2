...
var $author$project$TestImageCaptioned$view = function (_v0) {
	var input2 = '\\imagecentercaptioned{https://example.com/bird.jpg}{0.51\\textwidth}{Humming bird}\n';
	var input1 = '\\imagecentercaptioned{https://www.realsimple.com/thmb/7xn0oIF6a9eJ-y_4OO5vN0lJhCg=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/humming-bird-flowers-GettyImages-1271839175-b515cb4f06a34e66b084ba617995f00a.jpg}{0.51\\textwidth,keepaspectratio}{Humming bird}\n';
	var input = input2;
	var expectedOutput = '| image caption:Humming bird\nhttps://example.com/bird.jpg';
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Test: \\imagecentercaptioned')
					])),
				A2(
				$elm$html$Html$h2,
				_List_Nil,
...
var $author$project$TestImageCaptioned$main = $elm$browser$Browser$sandbox(
	{
		init: _Utils_Tuple0,
		update: F2(
			function (_v0, model) {
		...
		view: $author$project$TestImageCaptioned$view
	});
_Platform_export({'TestImageCaptioned':{'init':$author$project$TestImageCaptioned$main(
