...
var $author$project$MinimalHrefTest$main = function () {
	var latex3 = 'Check \\href{https://example.com}{example} and \\href{https://google.com}{google}.\n';
	var result3 = $author$project$Render$Export$LaTeXToScripta2$translate(latex3);
	var latex2 = 'This is a \\href{https://example.com}{link to a website}.\n';
	var result2 = $author$project$Render$Export$LaTeXToScripta2$translate(latex2);
	var latex1 = '\\href{https://example.com}{link to a website}\n';
	var result1 = $author$project$Render$Export$LaTeXToScripta2$translate(latex1);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Minimal href test')
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Test 1 (href alone):'),
						A2(
						$elm$html$Html$pre,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Input:  ' + latex1)
							])),
						A2(
						$elm$html$Html$pre,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Output: ' + result1)
							]))
					])),
				A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Test 2 (href in sentence):'),
						A2(
						$elm$html$Html$pre,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Input:  ' + latex2)
							])),
						A2(
						$elm$html$Html$pre,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Output: ' + result2)
							]))
					])),
				A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Test 3 (multiple hrefs):'),
						A2(
						$elm$html$Html$pre,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Input:  ' + latex3)
							])),
						A2(
						$elm$html$Html$pre,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Output: ' + result3)
							]))
					]))
			]));
}();
_Platform_export({'MinimalHrefTest':{'init':_VirtualDom_init($author$project$MinimalHrefTest$main)(0)(0)}});}(this));