...
var $author$project$TestMathMacros$test1Input = '\\newcommand{\\ket}[1]{| #1 \\rangle}\n\\newcommand{\\bra}[1]{\\langle #1 |}';
var $author$project$TestMathMacros$test2Input = '\\newcommand{\\od}[2]{\\frac{d #1}{d #2}}';
...
var $author$project$TestMathMacros$testCase = F2(
	function (input, title) {
		var output = $author$project$Render$Export$LaTeXToScripta2$mathMacros(input);
		var expected = _Utils_eq(input, $author$project$TestMathMacros$test1Input) ? $author$project$TestMathMacros$expectedOutput1 : (_Utils_eq(input, $author$project$TestMathMacros$test2Input) ? $author$project$TestMathMacros$expectedOutput2 : (_Utils_eq(input, $author$project$TestMathMacros$test3Input) ? $author$project$TestMathMacros$expectedOutput3 : (_Utils_eq(input, $author$project$TestMathMacros$test4Input) ? $author$project$TestMathMacros$expectedOutput4 : (_Utils_eq(input, $author$project$TestMathMacros$test5Input) ? $author$project$TestMathMacros$expectedOutput5 : ''))));
		var isCorrect = _Utils_eq(output, expected);
		var statusColor = isCorrect ? 'green' : 'red';
		var statusText = isCorrect ? '✓ PASS' : '✗ FAIL';
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
...
var $author$project$TestMathMacros$main = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Math Macros Conversion Test')
				])),
			A2($author$project$TestMathMacros$testCase, $author$project$TestMathMacros$test1Input, 'Test 1: Basic macros'),
			A2($author$project$TestMathMacros$testCase, $author$project$TestMathMacros$test2Input, 'Test 2: Complex frac macro'),
			A2($author$project$TestMathMacros$testCase, $author$project$TestMathMacros$test3Input, 'Test 3: Multiple macros'),
			A2($author$project$TestMathMacros$testCase, $author$project$TestMathMacros$test4Input, 'Test 4: Empty input'),
			A2($author$project$TestMathMacros$testCase, $author$project$TestMathMacros$test5Input, 'Test 5: Mixed content with non-macros')
		]));
_Platform_export({'TestMathMacros':{'init':_VirtualDom_init($author$project$TestMathMacros$main)(0)(0)}});}(this));