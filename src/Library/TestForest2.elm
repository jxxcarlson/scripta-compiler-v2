...
hottForestOfTOCNodeValue =
    makeForest Library.Tree.lev hottDataApp
...
depthsFromHottDataApp =
    { actual = makeForest Library.Tree.lev hottDataApp |> depths, ffDepths = depths ff, goal = [ 1, 1, 2, 1 ] }
...
fRepl =
    makeForest Library.Tree.lev nodesRepl
...
tList2 =
    list2
        |> Library.Tree.makeTree Library.Tree.lev
...
hottDepths =
    -- [1,1,2,1]: CORRECT
    List.map Library.Tree.depth hottForestOfTOCNodeValue
...
hottChildren =
    getChildren hottForestOfTOCNodeValue
