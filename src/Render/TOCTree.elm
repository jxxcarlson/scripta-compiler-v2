    ...
    let
        ...
        _ =
            Debug.log "@@::tocForest:SANITY_CHECK"
                { compareData = nodes == Library.TestForest2.hottDataApp
                , compareForests = forest == Library.TestForest2.hottForestOfTOCNodeValue
                , compareTOCValueForestsInViewToLib = testForest == Library.TestForest2.hottForestOfTOCNodeValue
                , depthsOfForestInApp = Library.Forest.depths forest
                , depthsOfForestInLib = Library.Forest.depths Library.TestForest2.hottForestOfTOCNodeValue
                , depthsOfForestInLibREPL = Library.TestForest2.depthsFromHottDataApp
...
viewTOCTree viewParameters acc depth indentation maybeFoundIds tocTree =
    let
        _ =
            Debug.log "@@::TOC_ROOT" ( (RoseTree.Tree.value tocTree).block.firstLine, List.length (RoseTree.Tree.children tocTree) )
